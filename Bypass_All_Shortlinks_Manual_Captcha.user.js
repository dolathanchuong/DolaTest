...
(function() { // Please Remember , My Scripts is better with Firefox Browser and Violentmonkey Extension
  ...
  function onHtmlLoaded() {
    ...
    BypassedByBloggerPemula(/dutchycorp.space|dutchycorp.ovh|gtlink.co|seulink.digital|adsen.link|oii.io|flyad.vip|antonimos.de|seulink.online|hamody.pro|fc-lc.xyz|fileku.net|metasafelink.site|(beingtek|fc-lc).com|(zagl|shrinkforearn).in|(kiiw|wordcounter).icu/, function() {
